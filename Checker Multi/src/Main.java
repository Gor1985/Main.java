...
import java.net.URLConnection;
        ...
        class CheckProxyClass implements Runnable {//extends Thread третий способ
            String ip;
            int port;

            // Конструктор
            public CheckProxyClass(String ip, int port) throws IOException {
                this.ip = ip;
                this.port = port;

            }
           // @Override второй способ
           // public void run() {
